$(document).ready(follow us.html){ 
    var=background,foreground1,header1,header2,p1,p2,p3,navBar,select box,foregroundVideo,searchBar,logoImage,toggleSlider,shoppingNavCart,parallex,
    ...
    background=$(document).css(background:HEX:F5F5F5; 
        ...
        p2=$(p2).class(fontFamily:helvetica);
        p3=$(p3).class(fontFamily:helvetica);
...
document.innerhtml=elementSetAttrById(#totalSum).table data(price);
 ...
 { 
    ...
    selectbox=$(ul:selectBox).chilren(homeLatest.html,events.html,registration.html,contactUS.html);
