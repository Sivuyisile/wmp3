$(document).ready(event.html){

    var=background,foreground1,header1,p1,navBar,select box,foregroundVideo,searchBar,logoImage,toggleSlider,shoppingNavCart,parallex;
